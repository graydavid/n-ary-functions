...
/**
 * Represents a function that accepts eight arguments and produces a result. This is the eight-arity specialization of
 * {@link Function}.
 * 
 ...
 */
@FunctionalInterface
public interface EightAryFunction<A, B, C, D, E, F, G, H, R> {
     ...
     */
    default <S> EightAryFunction<A, B, C, D, E, F, G, H, S> andThen(Function<? super R, ? extends S> after) {
