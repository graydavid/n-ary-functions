...
/**
 * Represents a function that accepts nine arguments and produces a result. This is the nine-arity specialization of
 * {@link Function}.
 * 
 ...
 */
@FunctionalInterface
public interface NineAryFunction<A, B, C, D, E, F, G, H, I, R> {
     ...
     */
    default <S> NineAryFunction<A, B, C, D, E, F, G, H, I, S> andThen(Function<? super R, ? extends S> after) {
